package com.mirea.belaya_da.lesson4;
...
public class MainActivity extends AppCompatActivity {
    ...
    private com.mirea.belaya_da.lesson4.databinding.ActivityMainBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.mirea.belaya_da.lesson4.databinding.ActivityMainBinding.inflate(getLayoutInflater());
    ...
    private void setupUI() {
        binding.trackTitle.setText("Беги по небу");
        binding.artistName.setText("Максим Фадеев");
        ...
        binding.totalTime.setText("2:17");
